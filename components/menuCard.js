...
const MenuCard = ({ titre, link, children }) => {
    return (
        <div className="flex flex-col justify-center items-center w-1/6 h-full border-2 p-5 rounded-lg border-gray-700	">
            <h3 className="text-white text-2xl mb-3">{titre}</h3>
